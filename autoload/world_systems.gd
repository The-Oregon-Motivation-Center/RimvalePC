...
const NAMED_NPCS: Array = [
	{"name": "Theron the Bold", "region": "plains", "role": "quest_giver", "desc": "A retired general who lost his arm in the Marches War.", "dialogue": ["The Shattered Marches still hold secrets.", "I once led 500 men into that hellscape.", "If you're heading north, watch for the bone pits."], "quest_hook": "retrieval"},
	{"name": "Sylvara Mistweave", "region": "forest", "role": "trainer", "desc": "An ancient elf who teaches natural magic.", "dialogue": ["The forest remembers what we forget.", "Every herb has a purpose.", "Close your eyes. Now listen."], "quest_hook": "ritual"},
	{"name": "Korth Ironforge", "region": "underground", "role": "merchant", "desc": "A dwarf merchant dealing in rare minerals and gems.", "dialogue": ["Aye, the deep places yield wealth beyond measure.", "Watch yer step down here. The dark has teeth.", "I'll trade ye fair, friend."], "quest_hook": "escort"},
	{"name": "Maelis Starwhisper", "region": "astral", "role": "lore_keeper", "desc": "A scholar of planar magic and cosmic phenomena.", "dialogue": ["The stars speak to those who listen.", "Reality is thinner here than elsewhere.", "What you see is not always what is."], "quest_hook": "investigation"},
	{"name": "Garrick Stonefist", "region": "frost", "role": "trainer", "desc": "A battle-hardened warrior training in the frozen wastes.", "dialogue": ["The cold sharpens the mind and the blade.", "Weakness is frozen out here.", "Survive a night on these plains and you'll survive anything."], "quest_hook": "defense"},
	{"name": "Lyris the Shadowblade", "region": "city", "role": "quest_giver", "desc": "A roguish figure with connections to the underground.", "dialogue": ["In the city, everything has a price.", "I know people. Good people. Dangerous people.", "What's yer business in the Bazaar?"], "quest_hook": "sabotage"},
	{"name": "Veris Moonfall", "region": "islands", "role": "merchant", "desc": "A pirate captain turned trader with stories of the deep.", "dialogue": ["The seas hold treasures and terrors in equal measure.", "I've seen things in the deep that would break yer mind.", "Interested in a voyage?"], "quest_hook": "exploration"},
	{"name": "Brother Aldric", "region": "arena", "role": "trainer", "desc": "A holy warrior of the Proving Grounds.", "dialogue": ["Combat is prayer. Victory is grace.", "Every scar teaches a lesson.", "Face yourself in the arena and you face truth."], "quest_hook": "tournament"},
	{"name": "Countess Erebis", "region": "throne", "role": "lore_keeper", "desc": "A noble with secrets about the royal lineage.", "dialogue": ["Power flows through blood and coin.", "The court is a battlefield where none bleed.", "Trust no one's smile, only their fear."], "quest_hook": "diplomacy"},
	{"name": "Kael Bonewright", "region": "titan", "role": "quest_giver", "desc": "A scholar fascinated by the giant corpses.", "dialogue": ["These titans fell ages ago. Yet their echoes remain.", "We walk upon the bones of gods.", "Their reach extends even in death."], "quest_hook": "retrieval"},
	{"name": "Marta Goldleaf", "region": "plains", "role": "merchant", "desc": "A half-orc farmer and trader of rare seeds.", "dialogue": ["Good soil, good harvest. Simple as that.", "The land provides if you respect it.", "Come spring, I'll have the finest crops in the realm."], "quest_hook": "escort"},
	{"name": "Rodrik the Wise", "region": "forest", "role": "lore_keeper", "desc": "A scholar of druidic traditions and beast speech.", "dialogue": ["The beasts have much to teach, if you listen.", "This forest is alive, truly alive.", "Some knowledge costs more than gold."], "quest_hook": "ritual"},
	{"name": "Grimble Sparkshine", "region": "underground", "role": "trainer", "desc": "A gnome inventor with gadgets and explosives.", "dialogue": ["Problem? I've got a contraption for that.", "Alchemy meets engineering down here.", "Careful with that. It's liable to explode."], "quest_hook": "sabotage"},
	{"name": "Zara the Void-touched", "region": "astral", "role": "quest_giver", "desc": "A human touched by planar energies, half-fey, half-mortal.", "dialogue": ["The void whispers truths mortals cannot bear.", "My blood sings with star-fire.", "Reality bends for those mad enough to push."], "quest_hook": "investigation"},
	{"name": "Bjorn Frostborn", "region": "frost", "role": "merchant", "desc": "A trader in furs, scales, and exotic animal parts.", "dialogue": ["The tundra provides everything if you know where to look.", "Beast hides fetch a fine price in warmer lands.", "Winter is coming. Always coming."], "quest_hook": "extermination"},
	{"name": "Lady Seraphine", "region": "city", "role": "lore_keeper", "desc": "A mysterious enchantress with a network of spies.", "dialogue": ["Information is more valuable than gold in the city.", "I know everyone. Everyone knows me.", "What would you trade for the truth?"], "quest_hook": "diplomacy"},
	{"name": "Thalassa the Pearl", "region": "islands", "role": "trainer", "desc": "A legendary sea priestess and navigator.", "dialogue": ["The tides speak in a language older than words.", "She who masters the waves masters destiny.", "The ocean calls to all who listen."], "quest_hook": "rescue"},
	{"name": "Daemon Bloodfist", "region": "arena", "role": "quest_giver", "desc": "A champion gladiator with a past shrouded in mystery.", "dialogue": ["Every scar is a story. Every story is written in blood.", "The arena doesn't lie. It shows what you truly are.", "Want glory? Step into the Blood Sands."], "quest_hook": "bounty_hunt"},
	{"name": "Duke Malachai", "region": "throne", "role": "merchant", "desc": "A wealthy noble dealing in political favors and secrets.", "dialogue": ["The kingdom is a game, and I know all the rules.", "Gold opens doors. Secrets open kingdoms.", "Shall we discuss business?"], "quest_hook": "sabotage"},
	{"name": "Esha Bonespeaker", "region": "titan", "role": "trainer", "desc": "A shaman who communes with the remnants of fallen gods.", "dialogue": ["The titans speak through bone and stone.", "Death is not the end, only a transition.", "Those who hear the songs of titans are forever changed."], "quest_hook": "ritual"},
]
