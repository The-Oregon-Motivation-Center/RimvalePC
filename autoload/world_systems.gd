...
const NAMED_NPCS: Array = [
	...
	{"name": "Korth Ironforge", "region": "underground", "lineage": "Ferrusk", "role": "merchant", "desc": "An iron-blooded merchant dealing in rare minerals and gems.", "dialogue": ["Aye, the deep places yield wealth beyond measure.", "Watch yer step down here. The dark has teeth.", "I'll trade ye fair, friend."], "quest_hook": "escort"},
